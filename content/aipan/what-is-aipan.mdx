...
<Plate shape="feet" label="Lakshmi Pad" caption="A complete Lakshmi Pad — two feet ringed with lotus petals, drawn at the threshold." />
...
<TwoUp a={{"shape": "dotgrid", "title": "Geru", "desc": "Red ochre clay — the ground layer."}} b={{"shape": "vasudhara", "title": "Bisvar", "desc": "Ground rice paste — the white lines."}} />
...
<Plate shape="dotgrid" label="The chowki layout" caption="A prepared geru ground, marked before the white lines are drawn." />
