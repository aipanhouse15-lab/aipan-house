...
<Plate shape="swastika" label="Ritual geometry" caption="Every Aipan pattern carries a ritual function, not just a look." />
...
<Plate shape="feet" label="The threshold" caption="At the dehri, Aipan consecrates the boundary between inside and outside." />
...
<Plate shape="swastika" label="Swastika" caption="Always clockwise — a symbol of auspiciousness and completion." />
...
<Plate shape="chowkiLotus" label="Carried forward" caption="The knowledge passes hand to hand, mother to daughter." />
