...
The Harela festival is the single occasion where Aipan is most universally practised across the Kumaon region, including by households that have otherwise let the tradition lapse. I document it in full at [the Harela festival guide](/festivals/harela).
...
Aipan House exists partly because this knowledge is in a fragile position. Not critically endangered, but thinning in ways that are hard to reverse once a generation passes. The patterns I document here — at [the Lakshmi Pad motif guide](/aipan/lakshmi-pad), [the Saraswati Chowki guide](/aipan/saraswati-chowki-lotus), and the additional motif pages I am adding through 2026 — are based on direct observation and interviews with practitioners in Almora, Bageshwar, and Pithoragarh districts.

The step-by-step process guide at [the step-by-step guide to making Aipan](/aipan/how-to-make-aipan) is aimed at people who want to learn the physical practice, not just read about it. The [What is Aipan?](/aipan/what-is-aipan) page provides the broader context for what you are learning.
