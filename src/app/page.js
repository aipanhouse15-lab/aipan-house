    ...
    <>
      ...
      <section id="valley" className="relative flex min-h-screen items-center overflow-hidden px-[8vw]"
        ...
        <div className="relative z-10 grid w-full items-center gap-8 md:grid-cols-2">
          ...
          <div className="hidden justify-center md:flex">
            <Motif shape="vasudhara" size={300} stroke="#2f3a26" sw={2.5} className="opacity-20" />
          </div>
        </div>
      </section>
      ...
      <section id="temple" className="relative flex min-h-screen items-center overflow-hidden px-[8vw]"
        ...
        <div className="relative z-10 grid w-full items-center gap-8 md:grid-cols-2">
          ...
          <div className="hidden justify-center md:flex">
            <Motif shape="chowkiLotus" size={320} stroke="#fbeee6" sw={1.6} className="opacity-30" />
          </div>
        </div>
      </section>
      ...
      <section id="peak" className="relative flex min-h-screen items-center overflow-hidden px-[8vw]"
        ...
        <div className="relative z-10 grid w-full items-center gap-8 md:grid-cols-2">
          ...
          <div className="hidden justify-center md:flex">
            <Motif shape="surmandir" size={300} stroke="#23323e" sw={2} className="opacity-20" />
          </div>
        </div>
      </section>
