...
export const metadata = { alternates: { canonical: '/aipan' }, title: 'Aipan — The Folk Art of Kumaon', description: 'The definitive guide to Aipan: origins, motifs decoded, and the geru-and-rice technique of Uttarakhand\'s sacred folk art.' }
